...
flags.DEFINE_integer("checkpoint", 800, "checkpoint to save and evaluate the model")
...
flags.DEFINE_float("grad_clip",4, "Global Norm gradient clipping rate")
flags.DEFINE_float("learning_rate", 0.001, "Learning rate")
flags.DEFINE_integer("lr_warm_up_num", 10000, "Number of warm-up steps of learning rate")
